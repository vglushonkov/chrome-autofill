...
echo "🚀 Building Fields Autofill Extension v1.0.0"
echo "============================================"
...
cp ICON_HIGHLIGHTING.md $BUILD_DIR/
...
cd $BUILD_DIR
zip -r "../$DIST_DIR/fields-autofill-v1.0.0.zip" . -x "*.git*" ".DS_Store"
cd ..

echo "📊 Build Summary:"
echo "=================="
echo "✅ Extension files copied to: $BUILD_DIR/"
echo "✅ ZIP archive created: $DIST_DIR/fields-autofill-v1.0.0.zip"

# Show file sizes
echo ""
echo "📏 Archive size:"
ls -lh "$DIST_DIR/fields-autofill-v1.0.0.zip"
...
echo "=============================="
echo "1. Upload $DIST_DIR/fields-autofill-v1.0.0.zip to Chrome Web Store"
